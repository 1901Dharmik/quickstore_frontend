...
export function BestsellerSection() {
  const { data: res, isPending, isError } = useQuery({
    ...
    queryFn: () => fetchProducts({ is_bestseller: true, limit: 8 }),
  });
  ...
  return (
    <ExploreCarouselSection
      ...
      description="Explore our most sought-after luxury timepieces, acclaimed for their styling and craftsmanship."
      cards={cards}
      viewAllHref="/shop"
    />
  );
